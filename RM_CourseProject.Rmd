...
Therefore, for this type of model (different intersections, with same slopes), set of sequence's N°1 regressors is selected ('wt', 'hp', 'disp' and 'am' -just in case, an extra ANOVA sequence was carried on, including 'gear' as a fifth regressor, with no relevant result obtained-).
...
Therefore, for this type of model, only 'wt', 'hp' and 'am' regressors were considered.
